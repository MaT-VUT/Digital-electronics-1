...
HD_PWD='C:/Users/matus/Documents/VYSOKA SKOLA/6.semester/DE1/Digital-electronics-1/Labs/04-segment/seven-segment display decoder/seven-segment display decoder.runs/impl_1'
cd "$HD_PWD"
